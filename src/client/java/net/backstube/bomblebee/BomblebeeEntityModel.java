...
/*
 * Copy of vanilla BeeEntityModel
 * */
public class BomblebeeEntityModel extends AnimalModel<BombleBeeServerEntity> {
    ...
    public BomblebeeEntityModel(ModelPart root) {
    ...
    public void animateModel(BombleBeeServerEntity beeEntity, float f, float g, float h) {
        super.animateModel(beeEntity, f, g, h);
        this.bodyPitch = beeEntity.getPitch(h);
        this.stinger.visible = true;
    }

    public void setAngles(BombleBeeServerEntity beeEntity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        if (true) {//if (!beeEntity.hasAngerTime()) {
            this.bone.pitch = 0.0F;
            this.bone.yaw = 0.0F;
            this.bone.roll = 0.0F;
            if (!bl) {
                k = MathHelper.cos(animationProgress * 0.18F);
